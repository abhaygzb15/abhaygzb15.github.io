...
const achievements: Achievement[] = [
  ...
  },
  {
    ...
    date: 'Oct 2023',
    description:
      'Served as Event Management Intern for USI (United Service Institution of India) at Manekshaw Centre, New Delhi — a think tank for national security.',
  },
  {
    category: 'volunteer',
    label: 'Volunteering',
