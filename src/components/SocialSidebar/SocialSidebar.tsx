...
const SocialSidebar = () => {
  return (
    <aside className="hidden md:flex fixed left-7 bottom-14 z-40 flex-col items-center gap-7">
      {socialLinks.map(({ href, icon, label }) => (
        <a
          ...
          aria-label={label}
          className="text-gray-500 hover:text-terminal-green transition-colors duration-200 hover:scale-110 transform"
        >
          {icon}
        </a>
      ))}
