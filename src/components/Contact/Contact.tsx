  ...
  return (
    <section id="contact" className="py-20 bg-terminal-bg">
      <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
        ...
        {/* ── 3 contact boxes ── */}
        <div className="reveal grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4" style={{ transitionDelay: '100ms' }}>
          ...
          <a
            ...
            className="group border border-terminal-border hover:border-terminal-green rounded-lg p-8
                       ...
                       hover:shadow-terminal hover:scale-105 bg-terminal-bg-card"
          >
            ...
            <p className="font-mono text-xs text-white group-hover:text-terminal-green
          ...
          <div className="border border-terminal-border rounded-lg p-8
            ...
            <p className="font-mono text-xs text-white">New Delhi, India</p>
          </div>
        </div>
