...
const projects: Project[] = [
  {
    ...
    github: 'private',
    demo: 'https://drive.google.com/file/d/1DpGA5OKlfiKRw4lv6VtfD9J0DegTBSPa/view',
    image: '/assets/p1.png',
  },
  {
    ...
    github: 'https://github.com/abhaygzb15/Vision-Language-Fusion-for-Advanced-Image-Captioning',
    image: '/assets/p2.png',
  },
  {
    ...
    demo: 'https://cic.du.ac.in/userfiles/downloads/SLP2024/Open%20ManipulatorX.pdf',
    github: 'private',
    image: '/assets/p3.jpg',
  },
  {
    ...
    demo: 'https://drive.google.com/file/d/1Ee4B_9VKftFu2SwfzAvndBJ90veWt7Ra/view?usp=embed_facebook',
    github: 'private',
    image: '/assets/p4.png',
  },
  {
    ...
    tech: ['NLP', 'OpenCV', 'Streamlit', 'Hugging Face', 'Pytorch'],
    github: 'https://github.com/abhaygzb15/Food-Delivery-Chatbot',
    image: '/assets/p5.png',
  },
  {
    ...
    github: 'https://github.com/abhaygzb15/Olympics-Data-Analysis',
    image: '/assets/p6.png',
  },
]
      ...
      <div className="relative z-10 container-max md:pl-8">
        ...
        <div className="space-y-8">
          {projects.map((project) => (
            ...
            >
              {/* ── Left: screenshot panel with Lens zoom ── */}
              <div className="lg:w-[38%] p-5 border-b lg:border-b-0 lg:border-r border-terminal-border/50 flex flex-col justify-between gap-4">
                <Lens
                  className="w-full h-52 md:h-56 rounded-lg border border-terminal-border/50 bg-terminal-bg overflow-hidden"
                  lensSize={130}
                  zoomFactor={1.6}
                >
                  <img
